...
class Predictor {
 public:
  ...
  virtual void PredictNoInsideCache(const SparsePage::Inst &inst,
                                         std::vector<bst_float>& out_preds,
                                         ...
                                         unsigned root_index,
                                         /*RegTree::FVec*/ void *void_thread_cache) = 0;
                                         
  virtual void PredictOutputSize(const SparsePage::Inst &inst,
